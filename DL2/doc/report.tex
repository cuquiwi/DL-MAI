...
In this report, we will focus on three types of models in the task of creating music from MIDI files. Apart from regular RNNs, we will experiment on \textit{Long Short-Term Memory} (LSTM) and \textit{Gated Recurrent Unit } (GRU) models
