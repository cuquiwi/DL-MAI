...
epochs = range(1, 201)
plt.title("RNN 64 nodes per layer training")
# plt.ylabel("Amount")
plt.xlabel("Epochs")
...
plt.clf()
plt.title("RNN 64 nodes per layer validation")
# plt.ylabel("Amount")
plt.xlabel("Epochs")
...
plt.clf()
plt.title("RNN 128 nodes per layer training")
# plt.ylabel("Amount")
plt.xlabel("Epochs")
...
plt.clf()
plt.title("RNN 128 nodes per layer validation")
# plt.ylabel("Amount")
plt.xlabel("Epochs")
